...
> Answer: Gives developers more control of the behavior and look of their website (reusable and dynamic code) 
> Answer: Does not have to refresh the entire page which means faster web responses. 
